...
Da wir noch keine Daten in R einlesen können, erzeugen wir uns zufällige Beispieldaten aus der Normalverteilung mit Mittelwert 0 und Standardabweichung 1. Diese Verteilung nennt man auch Standardnormalverteilung. Später im Kurs werden wir uns natürlich echten Daten widmen. Jedes Mal, wenn Sie das Tutorial starten, werden frische Zufallsdaten erzeugt, daher sehen die Muster in den Abbildungen etwas anders aus.
...
Unsere Daten sehen sehr unspektakulär aus, wie man es von normalverteilten Daten erwarten würde. Sie streuen um die 0, ihren Mittelwert. Natürlich ist ein x-y-Diagramm bei nur einer Variablen recht einfach. Nichtsdestotrotz, gehört diese Darstellungsform eindeutig in die Toolbox der explorativen Datenanalyse.
...
Das ist kein formaler Test, sondern ein graphisches Tool. Weil aber in der schließenden Statistik sehr viele formale Tests verlangen, dass die eigenen Daten normalverteilt seien (z.B. t-Test), schaut man sich eben QQ-Plots an.
...
question("Welche Aussagen über die Normalverteilung sind richtig?",
  ...
  answer("Ihr Mittelwert und Median sind immer sehr ähnlich.", correct = TRUE),
