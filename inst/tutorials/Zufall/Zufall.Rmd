...
`r emo::ji('question')` Kann man *Seltenheit* operationalisieren?

`r emo::ji('check')` Festlegung eines Grenzwerts ($\alpha$), z.B. $\alpha$ = 0.05 oder 5%
...
Wahrscheinlichkeit, Daten zu beobachten, die mindestens so extrem sind, wie in dem vorliegenden Datensatz, wenn die Nullhypothese gilt.
```
...
- Grenzwert für Entscheidung: $\alpha$ = 5%
